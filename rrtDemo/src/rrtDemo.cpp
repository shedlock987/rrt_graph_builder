...
std::get<0>(pose_t(-5.0, -5.0, 0.0, 0.0)), std::get<1>(pose_t(-5.0, -5.0, 0.0, 0.0)), std::get<0>(pose_t(5.0, 5.0, 10.0, 0.0)), std::get<1>(pose_t(5.0, 5.0, 10.0, 0.0)),
std::get<0>(pose_t(0.0, 0.0, 0.0, 0.7854)), std::get<1>(pose_t(0.0, 0.0, 0.0, 0.7854)), std::get<0>(pose_t(5.0, 5.0, 10.0, 0.0)), std::get<1>(pose_t(5.0, 5.0, 10.0, 0.0)),
...
// Constructor with occupancy map and pose_t arguments
...
_max_time, _dim_3D, _node_limit, _initial_heading))
{
}
// NEW: Constructor without occupancy map and pose_t arguments
...
class_<rrt::VisRRT, boost::noncopyable>("RRT", no_init)
        ...
        // UPDATED: With initial_heading (12 args)
